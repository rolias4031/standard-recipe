...
function FlowInputFrame({ col1, col2, row2col2, row3col2 }: FlowInputFrameProps) {
  ...
  return (
    ...
    >
      <div className="font-mono text-sm col-start-1 w-6 flex items-center justify-end text-concrete transition-colors group-hover:text-abyss">
        {col1}
      </div>
